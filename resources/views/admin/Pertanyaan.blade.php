          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Daftar Pertanyaan</h6>
              </div>
            </div>
                ...
                <table class="table w-100 align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Kode Gejala</th>
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">{{ $pertanyaan->kode_gejala }}</h6>
                            </div>
                          </div>
                        </td>
                        <td class="mb-0 text-sm" style="white-space: normal; word-break: break-word;">{{ $pertanyaan->pertanyaan }}</td>
                        <td class="text-sm">{{ $pertanyaan->kategori}}</td>
                        <td>
      ...
      <div class="modal-content">
        ...
        <form action="{{ route('pertanyaan.store') }}" method="POST">
          ...
          <div class="modal-body">
            ...
            <input type="checkbox" name="tampilkan_di_user" class="form-check-input" id="tampilkan_di_user" checked>
            <label for="tampilkan_di_user" class="form-check-label">Tampilkan ke User</label>
            </div>
          </div>
  ...
  <div class="modal fade" id="confirmDeleteModal" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="mb-2">Apakah Anda yakin ingin menghapus pertanyaan ?</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        editButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                // Set action URL
                document.getElementById('editForm').action = `/admin/pertanyaan/${id}`;
        ...
        document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
            if (currentDeleteId) {
                ...
                deleteForm.action = `/admin/pertanyaan/${currentDeleteId}`;
                deleteForm.submit();
            }
        });
