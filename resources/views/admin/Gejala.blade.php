          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Daftar Gejala</h6>
              </div>
            </div>
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">{{ $gejala->kode_gejala }}</h6>
                            </div>
                          </div>
                        </td>
                        <td class="mb-0 text-sm">{{ $gejala->nama_gejala }}</td>
                        <td class="text-sm">{{ $gejala->kategori}}</td>
                        <td>
        ...
        <form id="editForm" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <div class="input-group input-group-outline">
                <input type="text" name="nama_gejala" id="edit_nama_gejala" class="form-control" required>
              </div>
            </div>
            <div class="mb-3">
  ...
  <div class="modal fade" id="confirmDeleteModal" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="mb-2">Apakah Anda yakin ingin menghapus Gejala ?</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        editButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                const namaGejala = this.getAttribute('data-nama_gejala');
                ...
                document.getElementById('edit_nama_gejala').value = namaGejala;
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                const gejala = this.getAttribute('data-nama_gejala');

                // Update nama pakar di modal
                document.getElementById('gejala').textContent = namaGejala;
            });
        });
        ...
        document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
            if (currentDeleteId) {
                ...
                deleteForm.action = `/admin/gejala/${currentDeleteId}`;
                deleteForm.submit();
            }
        });
